                ...
                <div className="rigthChatIntroDiv">
                    <div className="rigthChatIntroContainer">
                        ...
                        <div className="rigthChatIntroContainerFooter">
                            ...
                            <p className="rigthChatIntroContainerText">Puoi visualizzare il codice sorgente su <a href="youtube.it" target="_blank" style={{color: "rgb(7, 188, 76)", textDecoration: "none"}}>GitHub</a>.</p>
                        </div>
                    </div>
                </div>
